...
# Prefijo de clave del caché para k-particiones, evita colisión con las claves
# de `bipartir` (que son pares de tuplas (alcance, mecanismo)).
KEY_KPART: str = "kpart"

# Prefijo de clave del caché de particiones evaluadas por la estrategia K-GeoMIP.
KEY_KGEOMIP: str = "kgeomip"
